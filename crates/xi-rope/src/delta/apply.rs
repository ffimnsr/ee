//! Delta application, factorization, synthesis, and debug formats.
use super::iter::{DeletionsIter, InsertsIter};
use super::*;
...
impl<N: NodeInfo> Delta<N> {
    ...
    pub(crate) fn total_element_len(els: &[DeltaElement<N>]) -> usize {
