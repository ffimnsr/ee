...
pub use proxy::{
    ...
    FileMatch, FilesystemResult, GitDiffResult, GitStatusResult, ListDirectoryAllResult,
    ListDirectoryResult, MAX_TOOL_ARGUMENT_BYTES, MAX_WORKSPACE_FACT_KEY_BYTES,
    MAX_WORKSPACE_FACT_LIST_RESULTS, MAX_WORKSPACE_FACT_QUERY_BYTES,
    MAX_WORKSPACE_FACT_VALUE_BYTES, MAX_WORKSPACE_MEMORY_IMPORT_BYTES, OpenBufferEntry,
    OpenBuffersResult, PlannedFileEdit, PlannedTextEdit, ProjectInstructionSource,
    ProjectInstructionsResult, ProxyToolError, ReferenceEntry, ReferencesResult,
    RenamePreviewResult, ReviewContextResult, SearchFilesAllResult, SearchFilesResult,
    SearchTextResult, SessionNoteResult, SessionNotesResult, SymbolDependencyLocation,
    SymbolDependencyMapResult, SymbolDependencyModuleHint, SymbolDependencyRelatedFile,
    SymbolDependencyRelation, SymbolDependencyTotals, TerminalOutputChunk, TerminalOutputResult,
    TerminalWaitResult, TextEdit, TextMatch, TextRange, ToolManifestEntry, ToolOutputCap,
    ToolsManifestResult, WebSearchEntry, WebSearchRequest, WebSearchResult, WebToolError,
    WebToolErrorCode, WorkspaceEditResult, WorkspaceFact, WorkspaceFactMutationResult,
