...
pub(crate) fn parse_action_spec(spec: &str) -> Result<Action, String> {
    ...
    let action = match spec {
        ...
        "command_delete_word" => Action::CommandDeleteWord,
        "command_clear_line" => Action::CommandClearLine,
        "command_history_window" => Action::CommandHistoryWindow,
        ...
        "one_shot_normal" => Action::OneShotNormal,
        "repeat_last_insert" => Action::RepeatLastInsert,
        "repeat_last_insert_and_exit" => Action::RepeatLastInsertAndExit,
        ...
        "paste_over_selection" => Action::PasteOverSelection,
...
pub(crate) fn format_action_spec(action: &Action) -> String {
    match action {
        ...
        Action::CommandDeleteWord => String::from("command_delete_word"),
        Action::CommandClearLine => String::from("command_clear_line"),
        Action::CommandHistoryWindow => String::from("command_history_window"),
        ...
        Action::OneShotNormal => String::from("one_shot_normal"),
        Action::RepeatLastInsert => String::from("repeat_last_insert"),
        Action::RepeatLastInsertAndExit => String::from("repeat_last_insert_and_exit"),
        ...
        Action::PasteOverSelection => String::from("paste_over_selection"),
